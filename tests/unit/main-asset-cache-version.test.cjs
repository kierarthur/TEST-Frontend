...
test('loads the current main frontend asset through an explicit cache version', () => {
  ...
  assert.match(main, /asset_version:\s*'20260817-banking-james-recovery-section-refresh-r2'/);
