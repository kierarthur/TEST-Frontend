...
test('loads the current main frontend asset through an explicit cache version', () => {
  const scriptBuildVersion = '20260729-invoice-v8-flat-table-r4';
  const stylesheetBuildVersion = '20260729-invoice-v8-flat-table-r4';
  ...
  assert.match(html, /invoice-batch-modal\.css\?v=20260729-invoice-v8-flat-table-r4/);
  assert.match(html, /invoice-diagnostic-catalog\.js\?v=20260728-invoice-async-v8-source-evidence-r1/);
  assert.match(html, /invoice-batch-modal\.js\?v=20260729-invoice-v8-flat-table-r4/);
