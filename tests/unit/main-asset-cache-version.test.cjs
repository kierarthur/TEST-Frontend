...
test('loads the current main frontend asset through an explicit cache version', () => {
  ...
  const diagnosticAsset = 'invoice-diagnostic-catalog.js?v=20260803-invoice-issue-copy-r1';
  ...
  assert.match(html, /invoice-diagnostic-catalog\.js\?v=20260803-invoice-issue-copy-r1/);
