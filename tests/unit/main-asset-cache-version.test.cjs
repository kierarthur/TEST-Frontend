...
test('loads the current main frontend asset through an explicit cache version', () => {
  const scriptBuildVersion = '20260730-invoice-v8-auto-recovery-r8';
  const stylesheetBuildVersion = '20260729-invoice-v8-flat-table-r5';
  const mainAsset = 'main.js?v=20260730-invoice-refs-ward-r10&banking-owner-recovery=20260730-r1&planned-week-authority=20260801-r2&invoice-email-policy=20260801-r2';
  ...
  assert.match(
    html,
    /<script src="\.\/js\/main\.js\?v=20260730-invoice-refs-ward-r10&banking-owner-recovery=20260730-r1&planned-week-authority=20260801-r2&invoice-email-policy=20260801-r2"><\/script>/
  );
  ...
  assert.match(html, /invoice-batch-modal\.js\?v=20260730-invoice-v8-auto-recovery-r8/);
