...
test('loads the current main frontend asset through an explicit cache version', () => {
  ...
  assert.match(html, /candidate-office-reminder-workspace-v1\.js\?v=20260813-r1/);
  assert.doesNotMatch(
    html,
  ...
  assert.match(main, /asset_version:\s*'20260813-banking-fast-route-modal-r1'/);
