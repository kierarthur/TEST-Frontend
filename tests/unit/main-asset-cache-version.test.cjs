...
test('loads the current main frontend asset through an explicit cache version', () => {
  ...
  const mainAsset = 'main.js?v=20260730-invoice-refs-ward-r10&banking-owner-recovery=20260730-r1&planned-week-authority=20260801-r2&invoice-email-policy=20260801-r1';
  ...
  assert.match(
    html,
    /<script src="\.\/js\/main\.js\?v=20260730-invoice-refs-ward-r10&banking-owner-recovery=20260730-r1&planned-week-authority=20260801-r2&invoice-email-policy=20260801-r1"><\/script>/
  );
